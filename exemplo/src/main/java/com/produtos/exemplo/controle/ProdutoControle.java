...
@CrossOrigin(origins="http://localhost:4200")//para ter acesso a outra porta de URL
@RestController  //diretorio padrao
@RequestMapping ("/api")
public class ProdutoControle {
	...
	public @ResponseBody List<ProdutoModelo> listarProdutos(){
		...
		//Cadastrar produtos
		@RequestMapping(value= "/produto", method = RequestMethod.POST) //metodo post é para enviar um dado
		...
		//Alterar produto
				@RequestMapping(value= "/produto", method = RequestMethod.PUT) //put ele entende que vai ser um update
